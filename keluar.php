                            ...
                            <div class="modal-content">
                                ...
                                <form method="post">
                                    <div class="modal-body">
                                        ...
                                        <input type="number" name="jumlah" placeholder="Jumlah Keluar" class="form-control" required>
                                        <br>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                if (!$ambildata || mysqli_num_rows($ambildata) == 0) {
                                    echo '<tr><td colspan="7" class="text-center">Belum ada data barang keluar.</td></tr>';
                                } else {
                                    while ($data = mysqli_fetch_assoc($ambildata)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= htmlspecialchars($data['jumlahkeluar']); ?></td>
                                            ...
                                            <td class="d-flex justify-content-center" style="gap: 8px">
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapus<?= $idk; ?>">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            ...
                                                            <label for="jumlah">Jumlah Keluar</label>
                                                            <input type="number" name="jumlah" value="<?= $data['jumlahkeluar']; ?>" class="form-control" required><br>
                                                            <label for="keterangan">Keterangan</label>
                                                            <input type="text" name="keterangan" value="<?= $data['keterangan']; ?>" class="form-control"><br>
                                                            <input type="hidden" name="idk" value="<?= $idk; ?>">
                                                            <input type="hidden" name="idd" value="<?= $idd; ?>">
                                                            <button type="submit" class="btn btn-primary" name="editbarangkeluar">Simpan Perubahan</button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                        ...
                                        <div class="modal fade" id="hapus<?= $idk; ?>">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        <div class="modal-body">
                                                            <?php $namabarang = $data['namabarang']; ?>
                                                            Apakah Anda yakin ingin menghapus transaksi keluar untuk 
                                                            <b><?= htmlspecialchars($namabarang); ?></b>?
                                                            <br><br>
                                                            <input type="hidden" name="idk" value="<?= $idk; ?>">
